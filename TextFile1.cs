...
public int cantidad = 10; // Cu�ntos vectores queremos
public float min = -5f;   // Valor m�nimo para cada componente
public float max = 5f;    // Valor m�ximo para cada componente
...
void Start()
{
    //int filas = Mathf.CeilToInt(Mathf.Sqrt(cantidad));  // n�mero de filas
    //int columnas = Mathf.CeilToInt((float)cantidad / filas); // n�mero de columnas

    float espaciado = 0.5f; // distancia entre part�culas en la grilla
